...
<link rel="next" href="https://www.cbr.washington.edu/qerm/index.php/Main_Page" />
...
<body class="mediawiki ltr ns--1 ns-special page-Special_Upload skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content">
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Not logged in</h1>
	<div id="bodyContent">
		<div id="siteSub">From QERM Wiki</div>
		<div id="contentSub"></div>
		<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>
		<!-- start content -->
<p>You must be <a href="/qerm/index.php/Special:UserLogin" title="Special:UserLogin">logged in</a> to upload files.
</p><p id="mw-returnto">Return to <a href="/qerm/index.php/Main_Page" title="Main Page">Main Page</a>.</p>
<div class="printfooter">
Retrieved from "<a href="https://www.cbr.washington.edu/qerm/index.php/Special:Upload">https://www.cbr.washington.edu/qerm/index.php/Special:Upload</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-special" class="selected"><a href="/qerm/index.php?title=Special:Upload&amp;wpDestFile=Sealion_RMark_l.R" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/qerm/index.php?title=Special:UserLogin&amp;returnto=Special:Upload&amp;returntoquery=wpDestFile%3DSealion_RMark_l.R" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "Special", "wgCanonicalSpecialPageName": "Upload", "wgNamespaceNumber": -1, "wgPageName": "Special:Upload", "wgTitle": "Upload", "wgAction": "view", "wgArticleId": 0, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 0, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionCreate": []});
}
</script>
<script>if ( window.mediaWiki ) {
