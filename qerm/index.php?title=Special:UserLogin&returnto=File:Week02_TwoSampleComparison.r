...
<form name="userlogin" method="post" action="/qerm/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=File:Week02_TwoSampleComparison.r">
	<h2>Log in</h2>
	<p id="userloginlink"></p>
		<div id="userloginprompt"><p>You must have cookies enabled to log in to QERM Wiki.
</p></div>
		<table>
		<tr>
...
<input type="hidden" name="wpLoginToken" value="cae6eda399dd9862bb448df17e78eb4f" /></form>
</div>
<div id="loginend"></div>
<div class="printfooter">
Retrieved from "<a href="https://www.cbr.washington.edu/qerm/index.php/Special:UserLogin">https://www.cbr.washington.edu/qerm/index.php/Special:UserLogin</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-special" class="selected"><a href="/qerm/index.php?title=Special:UserLogin&amp;returnto=File:Week02_TwoSampleComparison.r" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin" class="active"><a href="/qerm/index.php?title=Special:UserLogin&amp;returnto=File:Week02_TwoSampleComparison.r" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
