...
<form name="userlogin" method="post" action="/qerm/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=File:QERM598_IntroToAnovaLab.r">
	<h2>Log in</h2>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-special" class="selected"><a href="/qerm/index.php?title=Special:UserLogin&amp;returnto=File:QERM598_IntroToAnovaLab.r" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin" class="active"><a href="/qerm/index.php?title=Special:UserLogin&amp;returnto=File:QERM598_IntroToAnovaLab.r" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
